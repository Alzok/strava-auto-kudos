...
const CONFIG = {
    ...
    icons: {
        ...
        pause: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" height="16" width="16">
            <path d="M4.5 2C3.67 2 3 2.67 3 3.5v9c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5v-9C6 2.67 5.33 2 4.5 2zm7 0c-.83 0-1.5.67-1.5 1.5v9c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5v-9c0-.83-.67-1.5-1.5-1.5z" fill="currentColor"/>
        </svg>`,
        floatingSuccess: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path d="M15 6.633C15 5.848 14.394 5 13.416 5h-3.362c.208-.742.374-1.599.262-2.188-.24-1.257-1.57-2.044-1.835-2.189a1 1 0 00-1.469.725l-.307 1.996-2.44 4.522-3.124 1.201a1 1 0 00-.567 1.311l1.833 4.5a1 1 0 001.305.548L7.197 14h4.613c.833 0 1.549-.656 1.664-1.52l.275-1.923c.531-.406.83-.979.83-1.602 0-.274-.062-.572-.166-.83.378-.378.587-.901.587-1.492z" fill="currentColor"/>
        </svg>`,
